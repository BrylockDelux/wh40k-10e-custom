...
<gameSystem xmlns="http://www.battlescribe.net/schema/gameSystemSchema" id="sys-352e-adc2-7639-d6a0" name="Warhammer 40,000 10th Edition Custom" revision="10" battleScribeVersion="2.03" type="gameSystem">
  <publications>
  ...
  <categoryEntries>
    ...
    <categoryEntry id="5a2d-2f00-c054-4dcb" name="Faction: Carcharodons" hidden="false"/>
